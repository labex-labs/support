...
We've designed four categories of badges: Lab Badges, Skill Badges, [Skill Tree](/pages/using-labex/quick-start#skill-trees) Badges, and Streak Badges.
...
**[Skill Tree](/pages/using-labex/quick-start#skill-trees) Badges:** Earn a badge by mastering all the Skills on a specific [Skill Tree](/pages/using-labex/quick-start#skill-trees). Note: You don't need to finish all Labs; just gain all the Skills to achieve these badges.
