...
When you start a lab, LabEx will automatically create a new [Virtual Machine (VM)](/pages/using-labex/virtual-machine.mdx) for you. You can follow the instructions in the lab to practice in the VM.
...
- You'll receive a [Certificate of Completion](/pages/labex-pro/certificates-of-completion).
- We will [Plant a Real Tree](/pages/using-labex/green-learn-program) on your behalf.
