...
- Provide students with access to 30 [Skill Trees](/pages/using-labex/quick-start#skill-trees) encompassing labs and projects.
...
- Each student gains six months of complimentary [LabEx Pro](/pages/labex-pro/labex-pro-benifits) access, unlocking all labs except [Alibaba Cloud Labs](https://labex.io/alibaba).
...
See [LabEx Pro](/pages/labex-pro/labex-pro-benifits) for more details.
