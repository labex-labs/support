...
sidebarTitle: Desktop Interface
...
<Card title="Your First Linux Lab" icon="flask" href="https://labex.io/labs/linux-your-first-linux-lab-270253">
...
The Desktop Interface does not support file uploads and downloads. If you need to upload or download files, you can switch to the WebIDE interface.

Change the interface by clicking the "WebIDE" tab at the top of the page.
...
The default path for downloads and uploads is the `/home/labex/project` directory.
